...
@Tag(name = "소비자-쿠폰 매핑 컨트롤러", description = "소비자-쿠폰 관련 API 엔드포인트")
...
public class CustomerCouponController {
    ...
    @Operation(summary = "[소비자]쿠폰 적립", description = "쿠폰 적립하기")
    @ApiResponses(value = {
    ...
    @Operation(summary = "[소비자]쿠폰 사용하기", description = "쿠폰 사용하기")
    @ApiResponses(value = {
    ...
    @Operation(summary = "[소비자]쿠폰 숨기기 / 보이기", description = "쿠폰 숨김 또는 보임 설정하기")
    @ApiResponses(value = {
    ...
    @GetMapping("/my")
    @Operation(summary = "[소비자]내가 적립한 쿠폰 목록 조회", description = "내 적립 쿠폰 목록 페이징 조회하기")
    @ApiResponses(value = {
