...
//
//    @GetMapping("/{storeId}")
//    @Operation(summary = "[고객, 점주]상점 정보 조회", description = "상점 정보 조회하기")
//    @ApiResponses(value = {
...
//
//    @GetMapping
//    @Operation(summary = "[고객]상점 목록 조회", description = "상점 목록 페이징 조회하기")
//    @ApiResponses(value = {
...
//
//    @GetMapping
//    @Operation(summary = "[고객]상점 필터링 목록 조회", description = "상점 필터링 목록 페이징 조회하기")
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "상점 목록 조회 성공", content = @Content(schema = @Schema(implementation = StoreListResponse.class)))
//    })
//    public ResponseEntity<StoreListResponse> getStoreList(
